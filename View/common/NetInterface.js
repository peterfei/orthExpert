...
const Gk = {
  ...
  gk_getAppAuditState:"v1/app/xml/getAppAuditState",
  gk_checkIsBuyCombo:"/v1/app/combo/checkIsBuyCombo",
  gk_addOrder:"/v1/app/order/addOrder",
  gk_applyPayNotify:"/v1/app/pay/applyPayNotify",
  gk_funTypeList:"/v1/app/struct/funTypeList",
  gk_Ry_Store_Order_List:"Ry_Store_Order_List",
  gk_login:'v1/app/member/login',
  gk_forgetPwd:"/v1/app/member/forgetPwd",
  gk_register:"v1/app/member/register",
  gk_youkeLogin:"v1/app/member/youkeLogin",
  gk_getShareQR:"v1/app/basic/getShareQR",
  gk_getListByAppSearch:"v2/app/help/getListByAppSearch",
  gk_getPathologyAndArea:"v1/app/pathology/getPathologyAndArea",
  gk_getCodeAndCheckCapt:"/v1/app/member/getCodeAndCheckCapt",
  gk_boundTellNumberAndPassword:"/v1/app/member/boundTellNumberAndPassword",
  gk_codeLogin:"/v1/app/member/codeLogin",
  gk_isBoundTellNumber:"/v1/app/member/isBoundTellNumber",
  gk_isFirstWeixin:"v1/app/member/isFirstWeixin",
  gk_getCodeCheck:"/v1/app/member/getCodeCheck",
  gk_myOrder:"/v1/app/orthope/order/myOrder",
  gk_updateTellPassword:"v1/app/member/updateTellPassword",
  gk_config:"/v1/app/msg/config",
  gk_alipayGetPreyId:"/v1/app/pay/alipayGetPreyId",
  gk_myCombocouponList:"/v1/app/membercoupon/myCombocouponList",
  gk_appCaptcha:"http://118.24.119.234:8003/vesal-jiepao-test/appCaptcha",
}
