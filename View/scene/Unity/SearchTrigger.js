...
export default class SearchTrigger extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            searchResult: [],
            searchTitle: "",
            data: this.props.triggerList,
            fixData: this.props.triggerList,
    ...
    clickKey(obj) {
        ...
        if (this.props.app_id == 'QUYU0000') { // 全身疼痛区点击触发点
            this.props.clickTrigger(obj);
        } else {
            this.props.sendMsgToUnity("search", obj.trigger_no, '');
        }
    ...
    searchData(jsonObj, str, arr) {
        ...
        for (var key in jsonObj) {
            ...
            if (element.children.length == 0) {
                ...
                if (element.ch_name.indexOf(str) != -1) {
                    arr.push(element)
                }
            }
    ...
    generateMenu(menuObj) {
        ...
        if (menuObj instanceof Array) {
            ...
            let openIcon = null;
            if (menuObj.children && menuObj.children.length > 0) {
                icon = true ? null : <TouchableOpacity
