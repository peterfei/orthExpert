...
export default class SickDetail extends BaseComponent {
    ...
    cancelDownLoad(){
        if (jobId!=null&&ret!=null){
            ret =  RNFS.stopDownload(jobId);
            jobId = null;
            ret = null;
        }
    }
                ...
                arr.push(
                    <TouchableOpacity style={{marginBottom: size(30),}} onPress={() => {
                        ...
                        <ImageBackground
                            ...
                            <Image source={require('../../img/home/video.png')}
                                   style={{width: size(78), height: size(78)}}/>
                        </ImageBackground>
    ...
    _renderBottom() {
        ...
        this.state.menus.forEach((item, index) => {
            ...
            if (item.type == 'zhiliao') {
                ...
                if (list && list.length > 0) {
                    arr.push(
                        <TouchableOpacity style={{
                            ...
                            <Image resizeMode={'contain'} source={img} style={{
                                width: size(44),
                                height: size(44),
                                opacity: this.state.selectBtnIndex === index ? 0.8 : 1
                            }}/>
                            <Text style={{
                                fontSize: size(24),
                                color: color,
                ...
                arr.push(
                    <TouchableOpacity
                        style={{alignItems: 'center', justifyContent: 'center', width: size(104), height: size(104)}}
                        onPress={() => {
                            // this.selectBtn(index)
                            this.startIsUse(index)
                        }}>
